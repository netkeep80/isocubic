...
│   └── metamode/          # @netkeep80/metamode — библиотека MetaMode (Vue.js 3.0, Phase 9-10, 12 — TASK 72)
...
| 14   | [@netkeep80/metamode — выделение пакета в GitHub-репозиторий](docs/phase-14.md) | 🔄 В процессе (TASK 88-91 ✅) |
...
- [Phase 14: @netkeep80/metamode](docs/phase-14.md) — выделение пакета в GitHub-репозиторий, CI/CD публикация в GitHub Packages (TASK 88-92)
- [Инструкция по выделению @netkeep80/metamode](docs/metamode-extraction-guide.md) — подробная пошаговая инструкция по выделению пакета в GitHub-репозиторий и подключению обратно
...
- 4069+ тестов (116+ тестовых файлов основного проекта + 130 тестов пакета @netkeep80/metamode + 35 интеграционных тестов из dist/, все компоненты на @vue/test-utils)
...
- Тесты библиотеки @netkeep80/metamode (типы, утилиты, хранилище, MetaModeProvider, useMetaMode — TASK 72)
- Собственные тесты пакета @netkeep80/metamode (Vitest + @vue/test-utils, 130 тестов независимо от основного проекта — TASK 90)
- Интеграционные тесты @netkeep80/metamode (35 тестов, импорт из dist/, верификация всех публичных экспортов собранного пакета — TASK 91)

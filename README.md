...
|-------|----------|--------|
| [#85](https://github.com/netkeep80/isocubic/issues/85) | ISSUE 34: Унифицированный редактор | 🔄 В работе |
| [#74](https://github.com/netkeep80/isocubic/issues/74) | ISSUE 35: Система аутентификации | 🔄 В работе |

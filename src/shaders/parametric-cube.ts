/**
 * Parametric Cube Shader Strings
 * TypeScript module containing GLSL shader code for Three.js ShaderMaterial
 */
...
/**
 * Fragment shader for parametric cube
 * Implements:
 * - Base color rendering
 * - Gradient effects (X, Y, Z, radial axes)
...
/**
 * Default uniform values for the parametric cube shader
 */
export const defaultUniforms = {
  // Base material
  uBaseColor: { value: [0.5, 0.5, 0.5] },
  uRoughness: { value: 0.5 },
  uTransparency: { value: 1.0 },

  // Gradients (up to 4)
  uGradientCount: { value: 0 },
  uGradientAxis: { value: [0, 0, 0, 0] },
  uGradientFactor: { value: [0, 0, 0, 0] },
  uGradientColorShift: {
    value: [
      [0, 0, 0],
      [0, 0, 0],
  ...
  uNoiseMaskStart: { value: 0.0 },
  uNoiseMaskEnd: { value: 1.0 },
  uNoiseMaskAxis: { value: 0 },

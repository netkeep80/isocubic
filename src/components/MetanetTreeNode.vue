<!--
  MetanetTreeNode Component (Vue 3 SFC)

  Recursive tree node component for displaying MetaNet hierarchy.
  Used by MetanetTreePanel to render each node in the tree.
-->
<script setup lang="ts">
import type { CSSProperties } from 'vue'

defineOptions({ name: 'MetanetTreeNode' })

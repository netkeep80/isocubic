...
**Критерии приёмки**:
- [ ] Composable позволяет регистрировать окна с уникальными ID
- [ ] Состояние окон корректно сохраняется и загружается из localStorage
- [ ] Z-order управляется корректно при клике на окна
...
**Критерии приёмки**:
- [ ] Окно можно перетаскивать мышью и touch-жестами
- [ ] Размер окна изменяется во всех 8 направлениях
- [ ] Кнопки управления работают корректно
- [ ] Окно автоматически выводится на передний план при клике
- [ ] Анимации плавные и не вызывают лагов
- [ ] Работает на desktop, tablet и mobile устройствах
- [ ] Все тесты проходят
...
**Критерии приёмки**:
- [ ] Панель задач отображается внизу экрана
- [ ] Свёрнутые окна представлены иконками в taskbar
- [ ] Клик по иконке восстанавливает окно
- [ ] Активное окно визуально выделяется
...
**Критерии приёмки**:
- [ ] Командная строка открывается по Ctrl+K
- [ ] Команды распознаются на естественном языке (русский/английский)
- [ ] Поиск работает с нечётким соответствием
- [ ] История команд сохраняется и доступна
- [ ] Автодополнение помогает найти нужную команду
- [ ] Навигация с клавиатуры работает плавно
- [ ] Все тесты проходят

...
### TASK 49: AI Query Interface для DevMode
...
**Планируемые задачи**:
- [ ] Создание компонента DevModeQueryPanel
- [ ] Поле ввода для естественно-языковых запросов
- [ ] Область отображения ответов с форматированием
- [ ] История запросов с возможностью повторного использования
- [ ] Интеграция с DevMode контекстом

**Критерии приёмки**:
- Пользователь может вводить запросы на естественном языке
- Ответы отображаются в удобном формате
- История запросов сохраняется в сессии
- Панель можно свернуть/развернуть
- Поддержка клавиатурного сокращения для быстрого доступа

**Метки**: `ai`, `devmode`, `ui`, `query`

---

### TASK 50: AI Metadata Processor
...
**Планируемые задачи**:
- [ ] Создание модуля ai-metadata-processor.ts
- [ ] Индексация всех метаданных компонентов
...
|------|-----------|-----------|--------|
| 49. AI Query Interface | Средняя | Критический | Планируется |
| 50. AI Metadata Processor | Высокая | Критический | Планируется |
